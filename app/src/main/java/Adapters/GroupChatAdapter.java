...
public class GroupChatAdapter extends RecyclerView.Adapter {
    ...
    public GroupChatAdapter(ArrayList<MessageModel> messageModels, Context context, String receiveId) {
        this.messageModels = messageModels;
        this.context = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType==SENDER_VIEW_TYPE) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.sample_groupchat, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                database.getReference().child("Group chat").child(senderRoom)
        ...
        if (holder.getClass()== GroupChatAdapter.SenderViewHolder.class){
            ((GroupChatAdapter.SenderViewHolder)holder).senderTxt.setText(messageModel.getMessage());
            ...
            ((GroupChatAdapter.ReceiverViewHolder)holder).receiverTxt.setText(messageModel.getMessage());
//            ((ReceiverViewHolder)holder).receiverName.setText(messageModel.getUserName());
            Date date=new Date(messageModel.getTimeStamp());
            SimpleDateFormat simpleDateFormat=new SimpleDateFormat("h:mm a");
            String strDate=simpleDateFormat.format(date);
    ...
    public class ReceiverViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView receiverTxt,receiverTime,receiverName;
